...
class ModelTrainer(nn.Module):
    ...
    def train(self):
        ...
        for epoch in range(self.num_epochs):
            ...
            # self.optimizer.scheduler_step()  # 这里调用调度器的 step 方法
    ...
    def test(self, data, word_position, sentence_position):
        ...
        df = df.round(2)
        output_path = os.path.join(config_list.dir_output, f"{config_list.data_name}_{config_list.lr_decay}.xlsx")
...
model = model_attention.DocumentModel(config_list)
