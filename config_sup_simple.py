...
class Config():
    def __init__(self, parser=None, load=True):
        ...
        parser.add_argument('--batch_size', default='32', type=int,
                    help='batch size')
        parser.add_argument('--temprature', default='0.07', type=float,
                            help='temprature')
        ...
        parser.add_argument('--gamma', default='0.8', type=float,
                           help='gamma')
        parser.add_argument('--step_size', default='800', type=int,
                            help='step_size')
        ...
        parser.add_argument('--nepoch_no_imprv', default='20', type=int,
        ...
        # data and results paths  output_newgu_1
        parser.add_argument('--dir_output', default='output_sup/', type=str,
                    help='directory for output')
        parser.add_argument('--dir_out_class', default='output_re_run/', type=str,
                            help='directory for output')
                            #data_new_gu_1
        ...
        #parser.add_argument('--data_name', default='moxifloxacin', type=str,
        #                  help='name for dataset')
        #             kanamycin       amikacin capreomycin  streptomycin  moxifloxacin  ofloxacin
        ...
        self.path_log   = os.path.join(self.dir_output + '/' + self.data_name + '/' + self.folds, "log_sup"
                                                                                                  ".txt")
